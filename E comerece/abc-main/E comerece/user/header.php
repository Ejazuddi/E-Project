...
<head>
    ...
    <script src="https://kit.fontawesome.com/e20adfb025.js" crossorigin="anonymous"></script>
...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid font-monospace">
    <a class="navbar-brand pb-2"><img src="01.png " alt="" width="100"></a>
...
<div class="bg-danger font-monospace">
  <ul class="list-unstyled d-flex justify-content-center">
    <li><a href=""class="text-decoration-none text-white fw-bold fs-4 px-5">LAPTOPS</a></li>
    <li><a href=""class="text-decoration-none text-white  fw-bold fs-4 px-5">Mobile</a></li>
    <li><a href=""class="text-decoration-none text-white fw-bold fs-4 px-5">BAG</a></li>
